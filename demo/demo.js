...
jquery__WEBPACK_IMPORTED_MODULE_0__["extend"](window, _src_index__WEBPACK_IMPORTED_MODULE_1__);
var getDay = function (i) { return [
    _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].MO,
    _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].TU,
    _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].WE,
    _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].TH,
    _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].FR,
    _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].SA,
    _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].SU
][i]; };
...
var getOptionsCode = function (options) {
    ...
    var items = Object.keys(options).map(function (k) {
        ...
        if (v === null) {
            ...
            v = "RRule." + _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].FREQUENCIES[v];
        }
            ...
            if (v === _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].MO) {
                return '';
            }
            var w = v;
            v = days[w.weekday];
    ...
    return "{\n  " + items.filter(function (v) { return !!v; }).join(',\n  ') + "\n}";
};
var makeRows = function (dates) {
    ...
    var rows = dates.map(function (date, index) {
        var states = [];
        var parts = date.toUTCString().split(' ');
        var cells = parts.map(function (part, i) {
            if (part !== prevParts[i]) {
...
jquery__WEBPACK_IMPORTED_MODULE_0__(function () {
    ...
    var activateTab = function ($a) {
        ...
        return jquery__WEBPACK_IMPORTED_MODULE_0__("#input-types #" + id)
            .show()
            .find('input:first')
            .trigger('focus')
            .trigger('change');
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0__('#input-types section')
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0__('<a />', {
            href: "#" + jquery__WEBPACK_IMPORTED_MODULE_0__(this).attr('id')
        })
    ...
    var init;
    var makeRule;
    jquery__WEBPACK_IMPORTED_MODULE_0__('input, select').on('keyup change', function () {
        var _this = this;
        ...
        switch (inputMethod) {
            case 'text':
                makeRule = function () { return _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].fromText($in.val().toString()); };
                init = "RRule.fromText(\"" + this.value + "\")";
                break;
            case 'rfc':
                makeRule = function () { return _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"].fromString(_this.value); };
            ...
            case 'options':
                ...
                for (var k in values) {
                    ...
                    switch (key) {
                        case 'dtstart':
                        case 'until':
                            var date = new Date(Date.parse(value + 'Z'));
                            options_1[key] = date;
                            continue;
                        case 'byweekday':
                            if (Array.isArray(value)) {
                                options_1[key] = value.map(function (i) { return getDay(parseInt(i, 10)); });
                            }
                            else {
                                options_1[key] = getDay(parseInt(value, 10));
                            }
                            continue;
                        case 'wkst':
                            options_1[key] = getDay(parseInt(value, 10));
                        ...
                        case 'bynmonthday':
                            ...
                            options_1[key] = value.map(function (n) { return parseInt(n, 10); });
                            continue;
                        case 'bynweekday':
                            if (!Array.isArray(value)) {
                                value = value.split(/[,\s]+/);
                            ...
                            continue;
                        case 'byeaster':
                            options_1[key] = parseInt(value, 10);
                            continue;
                        case 'freq':
                        case 'count':
                            options_1[key] = parseInt(value, 10);
                ...
                makeRule = function () { return new _src_index__WEBPACK_IMPORTED_MODULE_1__["RRule"](options_1); };
                init = "new RRule(" + getOptionsCode(options_1) + ")";
        ...
        try {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0__('#init').append(jquery__WEBPACK_IMPORTED_MODULE_0__('<pre class="error"/>').text("=> " + String(e || null)));
            return;
        }
        var rfc = rule.toString();
      var text = rule.toText();
      document.getElementById('eventRecur').value = rule.toString()
    ...
    var processHash = function () {
        ...
        if (hash) {
            ...
            if (match) {
                ...
                var arg = match[2];
                activateTab(jquery__WEBPACK_IMPORTED_MODULE_0__("a[href='#" + method + "-input']"));
                return jquery__WEBPACK_IMPORTED_MODULE_0__("#" + method + "-input input:first")
                    .val(arg)
                    .trigger('change');
            }
        }
...
/* harmony import */ var _iterresult__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./iterresult */ "./src/iterresult.ts");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
...
/* harmony import */ var _iterresult__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./iterresult */ "./src/iterresult.ts");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers */ "./src/helpers.ts");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
...
var DateTime = /** @class */ (function (_super) {
    ...
    DateTime.prototype.add = function (options, filtered) {
        ...
        switch (freq) {
            case _types__WEBPACK_IMPORTED_MODULE_1__["Frequency"].YEARLY: return this.addYears(interval);
            case _types__WEBPACK_IMPORTED_MODULE_1__["Frequency"].MONTHLY: return this.addMonths(interval);
            case _types__WEBPACK_IMPORTED_MODULE_1__["Frequency"].WEEKLY: return this.addWeekly(interval, wkst);
            case _types__WEBPACK_IMPORTED_MODULE_1__["Frequency"].DAILY: return this.addDaily(interval);
            case _types__WEBPACK_IMPORTED_MODULE_1__["Frequency"].HOURLY: return this.addHours(interval, filtered, byhour);
            case _types__WEBPACK_IMPORTED_MODULE_1__["Frequency"].MINUTELY: return this.addMinutes(interval, filtered, byhour, byminute);
            case _types__WEBPACK_IMPORTED_MODULE_1__["Frequency"].SECONDLY: return this.addSeconds(interval, filtered, byhour, byminute, bysecond);
        }
    };
    return DateTime;
}(Time));
...
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
...
/* harmony import */ var _weekday__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./weekday */ "./src/weekday.ts");
// =============================================================================
// Helper functions
// =============================================================================
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: rrulestr, Frequency, Weekday, RRule, RRuleSet, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rrule */ "./src/rrule.ts");
...
/* harmony import */ var _rruleset__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rruleset */ "./src/rruleset.ts");
...
/* harmony import */ var _rrulestr__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rrulestr */ "./src/rrulestr.ts");
...
/* harmony import */ var _weekday__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./weekday */ "./src/weekday.ts");
...
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../dateutil */ "./src/dateutil.ts");
/* harmony import */ var _iterinfo_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../iterinfo/index */ "./src/iterinfo/index.ts");
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../rrule */ "./src/rrule.ts");
/* harmony import */ var _parseoptions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../parseoptions */ "./src/parseoptions.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../helpers */ "./src/helpers.ts");
/* harmony import */ var _datewithzone__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../datewithzone */ "./src/datewithzone.ts");
/* harmony import */ var _poslist__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./poslist */ "./src/iter/poslist.ts");
/* harmony import */ var _datetime__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../datetime */ "./src/datetime.ts");
...
/* harmony import */ var _yearinfo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./yearinfo */ "./src/iterinfo/yearinfo.ts");
/* harmony import */ var _monthinfo__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./monthinfo */ "./src/iterinfo/monthinfo.ts");
/* harmony import */ var _easter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./easter */ "./src/iterinfo/easter.ts");
/* harmony import */ var _datetime__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../datetime */ "./src/datetime.ts");
...
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../dateutil */ "./src/dateutil.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers */ "./src/helpers.ts");
/* harmony import */ var _masks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../masks */ "./src/masks.ts");
...
function rebuildYear(year, options) {
    ...
    var result = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ yearlen: yearlen,
    ...
    if (no1wkst >= 4) {
        ...
        // from last year.
        wyearlen =
            result.yearlen + Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["pymod"])(yearweekday - options.wkst, 7);
    }
    else {
...
/* harmony import */ var _datewithzone__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./datewithzone */ "./src/datewithzone.ts");
/* harmony import */ var _iter_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./iter/index */ "./src/iter/index.ts");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
...
function iterSet(iterResult, _rrule, _exrule, _rdate, _exdate, tzid) {
    ...
    _rrule.forEach(function (rrule) {
        Object(_iter_index__WEBPACK_IMPORTED_MODULE_1__["iter"])(iterResult, rrule.options);
    });
...
var M365MASK = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(1, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(2, 28), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(3, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(4, 30), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(5, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(6, 30), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(7, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(8, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(9, 30), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(10, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(11, 30), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(12, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(1, 7));
var M366MASK = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(1, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(2, 29), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(3, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(4, 30), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(5, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(6, 30), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(7, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(8, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(9, 30), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(10, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(11, 30), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(12, 31), Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["repeat"])(1, 7));
...
var MDAY366MASK = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(M31, M29, M31, M30, M31, M30, M31, M31, M30, M31, M30, M31, M31.slice(0, 7));
var MDAY365MASK = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(M31, M28, M31, M30, M31, M30, M31, M31, M30, M31, M30, M31, M31.slice(0, 7));
...
var NMDAY366MASK = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(NM31, NM29, NM31, NM30, NM31, NM30, NM31, NM31, NM30, NM31, NM30, NM31, NM31.slice(0, 7));
var NMDAY365MASK = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])(NM31, NM28, NM31, NM30, NM31, NM30, NM31, NM31, NM30, NM31, NM30, NM31, NM31.slice(0, 7));
...
/* harmony import */ var _totext__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./totext */ "./src/nlp/totext.ts");
/* harmony import */ var _parsetext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parsetext */ "./src/nlp/parsetext.ts");
...
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../types */ "./src/types.ts");
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./i18n */ "./src/nlp/i18n.ts");
...
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./i18n */ "./src/nlp/i18n.ts");
...
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rrule */ "./src/rrule.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ "./src/helpers.ts");
/* harmony import */ var _weekday__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weekday */ "./src/weekday.ts");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
/* harmony import */ var _datewithzone__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./datewithzone */ "./src/datewithzone.ts");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers */ "./src/helpers.ts");
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./rrule */ "./src/rrule.ts");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
/* harmony import */ var _weekday__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./weekday */ "./src/weekday.ts");
/* harmony import */ var _datetime__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./datetime */ "./src/datetime.ts");
...
function parseOptions(options) {
    ...
    if (Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["isPresent"])(opts.byeaster))
        opts.freq = _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].YEARLY;
    if (!(Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["isPresent"])(opts.freq) && _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].FREQUENCIES[opts.freq])) {
        throw new Error("Invalid frequency: " + opts.freq + " " + options.freq);
    }
    if (!opts.dtstart)
        opts.dtstart = new Date(new Date().setMilliseconds(0));
    if (!Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["isPresent"])(opts.wkst)) {
        opts.wkst = _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].MO.weekday;
    }
    ...
    if (!(Boolean(opts.byweekno) ||
        ...
        switch (opts.freq) {
            case _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].YEARLY:
                if (!opts.bymonth)
                    opts.bymonth = opts.dtstart.getUTCMonth() + 1;
                opts.bymonthday = opts.dtstart.getUTCDate();
                break;
            case _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].MONTHLY:
                opts.bymonthday = opts.dtstart.getUTCDate();
                break;
            case _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].WEEKLY:
    ...
    if (!Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["isPresent"])(opts.byweekday)) {
        ...
        if (!opts.byweekday.n || opts.freq > _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].MONTHLY) {
        ...
        for (var i = 0; i < opts.byweekday.length; i++) {
            ...
            if (!wday.n || opts.freq > _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].MONTHLY) {
    ...
    if (!Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["isPresent"])(opts.byhour)) {
        opts.byhour =
            opts.freq < _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].HOURLY ? [opts.dtstart.getUTCHours()] : null;
    }
    ...
    if (!Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["isPresent"])(opts.byminute)) {
        opts.byminute =
            opts.freq < _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].MINUTELY ? [opts.dtstart.getUTCMinutes()] : null;
    }
    ...
    if (!Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["isPresent"])(opts.bysecond)) {
        opts.bysecond =
            opts.freq < _rrule__WEBPACK_IMPORTED_MODULE_3__["default"].SECONDLY ? [opts.dtstart.getUTCSeconds()] : null;
    }
...
/* harmony import */ var _weekday__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weekday */ "./src/weekday.ts");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./rrule */ "./src/rrule.ts");
...
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
/* harmony import */ var _iterresult__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./iterresult */ "./src/iterresult.ts");
/* harmony import */ var _callbackiterresult__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./callbackiterresult */ "./src/callbackiterresult.ts");
/* harmony import */ var _nlp_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./nlp/index */ "./src/nlp/index.ts");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./types */ "./src/types.ts");
/* harmony import */ var _parseoptions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./parseoptions */ "./src/parseoptions.ts");
/* harmony import */ var _parsestring__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./parsestring */ "./src/parsestring.ts");
/* harmony import */ var _optionstostring__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./optionstostring */ "./src/optionstostring.ts");
/* harmony import */ var _cache__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./cache */ "./src/cache.ts");
/* harmony import */ var _weekday__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./weekday */ "./src/weekday.ts");
/* harmony import */ var _iter_index__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./iter/index */ "./src/iter/index.ts");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rrule */ "./src/rrule.ts");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers */ "./src/helpers.ts");
/* harmony import */ var _iterset__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./iterset */ "./src/iterset.ts");
/* harmony import */ var _rrulestr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./rrulestr */ "./src/rrulestr.ts");
/* harmony import */ var _optionstostring__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./optionstostring */ "./src/optionstostring.ts");
...
var RRuleSet = /** @class */ (function (_super) {
    ...
    return RRuleSet;
}(_rrule__WEBPACK_IMPORTED_MODULE_1__["default"]));
/* harmony default export */ __webpack_exports__["default"] = (RRuleSet);
function _addRule(rrule, collection) {
    if (!(rrule instanceof _rrule__WEBPACK_IMPORTED_MODULE_1__["default"])) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _rrule__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rrule */ "./src/rrule.ts");
/* harmony import */ var _rruleset__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rruleset */ "./src/rruleset.ts");
/* harmony import */ var _dateutil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dateutil */ "./src/dateutil.ts");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers */ "./src/helpers.ts");
/* harmony import */ var _parsestring__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./parsestring */ "./src/parsestring.ts");
...
function parseInput(s, options) {
    ...
    var exrulevals = [];
    var exdatevals = [];
    var _a = Object(_parsestring__WEBPACK_IMPORTED_MODULE_5__["parseDtstart"])(s), dtstart = _a.dtstart, tzid = _a.tzid;
...
function buildRule(s, options) {
    ...
    if (options.forceset ||
        ...
        exrulevals.length ||
        exdatevals.length) {
        var rset_1 = new _rruleset__WEBPACK_IMPORTED_MODULE_2__["default"](noCache);
        rset_1.dtstart(dtstart);
        rset_1.tzid(tzid || undefined);
        rrulevals.forEach(function (val) {
            rset_1.rrule(new _rrule__WEBPACK_IMPORTED_MODULE_1__["default"](groomRruleOptions(val, dtstart, tzid), noCache));
        });
        rdatevals.forEach(function (date) {
            rset_1.rdate(date);
        });
        exrulevals.forEach(function (val) {
            rset_1.exrule(new _rrule__WEBPACK_IMPORTED_MODULE_1__["default"](groomRruleOptions(val, dtstart, tzid), noCache));
        });
    ...
    var val = rrulevals[0] || {};
    return new _rrule__WEBPACK_IMPORTED_MODULE_1__["default"](groomRruleOptions(val, val.dtstart || options.dtstart || dtstart, val.tzid || options.tzid || tzid), noCache);
}
...
function groomRruleOptions(val, dtstart, tzid) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, val), { dtstart: dtstart,
        tzid: tzid });
}
function initializeOptions(options) {
    var invalid = [];
